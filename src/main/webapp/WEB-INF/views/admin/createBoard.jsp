...
<div class="row">
	<div class="col-md-12">
		<div class="card card-default">
			<div class="card-body">
				<form id="createForm" action="/admin/insertContent" method="post">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<button type="button" id = "crtBtn" class="btn btn-block btn-outline-info">글 등록하기</button>
						</div>
					</div>
					<sec:csrfInput/>
				</form>
